...
def explain_cases_baseline(test_loader_seg, device, cls_model, threshold, baseline_img, cat_id):
    cls_model.eval()
    iou_list_test_case = []
    dice_list_test_case = []
...
def explain_cases_cons(test_loader_seg, device, cls_model, threshold, baseline_img, cat_id):
    cls_model.eval()
    iou_list_test_case = []
    dice_list_test_case = []
    baseline_img = torch.tensor(baseline_img).to(device=device, dtype=torch.float)
