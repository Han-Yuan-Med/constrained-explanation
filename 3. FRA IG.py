...
results_df = []
#
# Alex_optimal = torch.load("model\\fra-AlexNet.pt")
#
...
Res18_optimal = torch.load("model\\fra-Res18.pt")
...
pd.DataFrame(results_df).to_csv("Result\\fra_ig.csv", index=False, encoding="cp1252")
