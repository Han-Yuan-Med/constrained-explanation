...
results_df = []
#
# Alex_optimal = torch.load("model\\ptx-AlexNet.pt")
#
...
Res18_optimal = torch.load("model\\ptx-Res18.pt")
...
pd.DataFrame(results_df).to_csv("Result\\ptx_ig.csv", index=False, encoding="cp1252")
