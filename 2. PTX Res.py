...
for child in Res18_model.children():
    print(child)
...
results_df = [[f"Res-18", f"{thres_val}",
...
results_df.columns = ['Model', 'Threshold', 'AUROC', 'AUPRC', 'Accuracy', 'Sensitivity', 'Specificity',
                      'PPV', 'NPV']
results_df.to_csv("Result\\ptx_cls_res_18.csv", index=False, encoding="cp1252")
