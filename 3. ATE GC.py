...
#                            cls_model=alex_grad_cam(Alex_optimal), threshold=95)
#
...
iou_list_test_case, dice_list_test_case, iou_case, dice_case = \
    explain_cases_baseline(test_loader_seg=test_cases_loader_bsl, device=device,
                           cls_model=res_grad_cam(Res18_optimal), threshold=95)
...
pd.DataFrame(results_df).to_csv("Result\\ate_gc.csv", index=False, encoding="cp1252")
